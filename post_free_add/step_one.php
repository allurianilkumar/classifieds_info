<html>
<?php require '../config/_config_database.php'; ?>
        ...
        <div class="col-lg-5 col-md-5 col-sm-8 col-xs-9 bhoechie-tab-container">
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 bhoechie-tab-menu">
              <div class="list-group">
                        <?php
                        $sql = "SELECT `name`, `glyphicon` FROM `product_title`";
                        $res = $conn->query($sql);
                        $cnt = $res->num_rows;
                        ...
                        <?php while ($fetch = $res->fetch_assoc()) { ?>
                          ...
                          <h4 class="<?php echo $fetch['glyphicon']?>"></h4><br/><?php echo $fetch['name']?>
                          </a>
                        <?php } ?>
                        <?php 
                        }else{
...
<!--                 <a href="#" class="list-group-item active text-center">
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 bhoechie-tab">
                ...
                <h1 class="glyphicon glyphicon-education" style="font-size:6em;color:#55518a"></h1>
                    <div class="container">
                      <div class="row">
                         <form id="education_form" action="../post_free_add/step_two.php" method="post">
                    ...
                    <h1 class="glyphicon glyphicon-phone" style="font-size:6em;color:#55518a"></h1>
                        <div class="container">
                          <div class="row">
                              ...
                              <form id="mobiles_form" action="../post_free_add/step_two.php" method="post">
                           ...
                           <p class='mobiles_container'>  
                              ...
                              <?php while ($fetch = $res->fetch_assoc()) { ?>                                
                              <label class="radio-inline">
                              <input type="radio" name="radioGroup" id="radio1" value="<?php echo $fetch['brand_name']?>"><?php echo $fetch['brand_name']?> 
                              </label><br>
                                <?php } ?>
                                <?php 
                                }else{
                    ...
                    <h1 class="glyphicon glyphicon-credit-card" style="font-size:6em;color:#55518a"></h1>
                        <div class="container">
                          <div class="row">
                              ...
                              <form id="electronics_form" action="../post_free_add/step_two.php" method="post" >
                              <h1>Electronics</h1>
...
<!--                    <center>
                    ...
                    <h1 class="glyphicon glyphicon-education" style="font-size:6em;color:#55518a"></h1>
                        <div class="container">
                          <div class="row">
                              <form id="jobs_form" action="../post_free_add/step_two.php" method="post">
                                <h1>jobs</h1>
...
<!--                    <center>
                    ...
                    <h1 class="glyphicon glyphicon-wrench" style="font-size:6em;color:#55518a"></h1>
                        <div class="container">
                          <div class="row">
                              <form id="services_form" action="../post_free_add/step_two.php" method="post">
                              <h1>Services</h1>
...
<!--                    <center>
                    ...
                    <h1 class="glyphicon glyphicon-play" style="font-size:6em;color:#55518a"></h1>
                        <div class="container">
                          <div class="row">
                              <form id="entertainment_form" action="../post_free_add/step_two.php" method="post">
                              <h1>Entertainment</h1>
  ...
  <!--                     <center>
                   <h1 class="glyphicon glyphicon-road" style="font-size:6em;color:#55518a"></h1>
                    ...
                    <h1 class="glyphicon glyphicon-cutlery" style="font-size:6em;color:#55518a"></h1>
                        <div class="container">
                          <div class="row">
                              <form id="community_form" action="../post_free_add/step_two.php" method="post">
...
<!--                    <center>
                    ...
                    <h1 class="glyphicon glyphicon-heart" style="font-size:6em;color:#55518a"></h1>
                        <div class="container">
                          <div class="row">
                              <form id="matrimony_form" action="../post_free_add/step_two.php" method="post">
                              <h1>Matrimmony</h1>
...
<!--                    <center>
                    ...
                    <h1 class="glyphicon glyphicon-Home" style="font-size:6em;color:#55518a"></h1>
                        <div class="container">
                          <div class="row">
                              <form id="realestate_form" action="../post_free_add/step_two.php" method="post">
                              <h1>Real Estate</h1>
