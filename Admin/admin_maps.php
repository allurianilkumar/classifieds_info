...
<head>
  ...
  <link href="index.phpjqvmap/jqvmap.css" media="screen" rel="stylesheet" type="text/css" />   
      ...
      <div class="templatemo-content-wrapper">
        ...
        <footer class="templatemo-footer">
          <div class="templatemo-copyright">
            <p>Copyright &copy; HACKRONS IT NETWORK SOLUTIONS <!-- Credit: www.templatemo.com --></p>
          </div>
        </footer>
      </div>
	</div>
