...
<body>
  <div class="navbar navbar-inverse" role="navigation">
    ...
    <div class="template-page-wrapper">
      <div class="navbar-collapse collapse templatemo-sidebar">
        <ul class="templatemo-sidebar-menu">
         ...
         <li class="active"><a href="#"><i class="fa fa-home"></i>Home</a></li>
          <li class="sub open">
            <a href="javascript:;">
              <i class="fa fa-database"></i> Operations<div class="pull-right"><span class="caret"></span></div>
            </a>
          ...
          <li><a href="admin_data-visualization.php"><i class="fa fa-cubes"></i><span class="badge pull-right">9</span>Data Visualization</a></li>
          <li><a href="admin_maps.php"><i class="fa fa-map-marker"></i><span class="badge pull-right">42</span>Maps</a></li>
          <li><a href="admin_tables.php"><i class="fa fa-users"></i><span class="badge pull-right">NEW</span>Manage Users</a></li>
          <li><a href="admin_preferences.php"><i class="fa fa-cog"></i>Preferences</a></li>
          <li><a href="admin_javascript:;" data-toggle="modal" data-target="#confirmModal"><i class="fa fa-sign-out"></i>Sign Out</a></li>
        </ul>
      </div><!--/.navbar-collapse -->
          ...
          <div class="templatemo-panels">
            <div class="row">
              ...
              <div class="col-md-6 col-sm-6 margin-bottom-30">
                ...
                <span class="btn btn-primary"><a href="admin_tables.php">See Tables</a></span>
              </div>       
            </div>
            <div class="row">
      ...
      <footer class="templatemo-footer">
        <div class="templatemo-copyright">
          <p>Copyright &copy;HACKRONS IT NETWORK SOLUTIONS</p>
        </div>
      </footer>
    </div>
    ...
    <script src="./admin_js/templatemo_script.js"></script>
