    ...
    <input type="text" class="form-control" placeholder="What are you search for?">
      <span class="input-group-btn">
        ...
        <ul class="nav navbar-nav navbar-right">
                   ...
                   <div class="row">
                          <div class="col-sm-6"  id="login_size" >
                              ...
                              <hr id="smiple_line_for_singn_up">
							   ...
							   <center><h3>User Login<hr></h3></center>
                             <div class="form-group">
                          ...
                          <div class="bottom text-center">
                              New here ? <a href="/classiads/sign_up/"><b>Sign Up</b></a>
                          </div>
                   </div>
                  </li>
              </ul>
          ...
          <li>
              <form class="navbar-form navbar-left" role="search">
                  <button type="submit" class="btn btn-info" id="post_colr"><a href="post_free_add/step_one.php">POST FREE ADD</a></button>
              </form>
          </li>
        </ul>
      </div><!-- /.navbar-collapse -->
