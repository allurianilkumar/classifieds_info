...
<?php require 'navbar.php';?>
  ...
  <div class="panel-heading">
     <center><span class="glyphicon glyphicon-home">REAL ESTATE</span></center></div>
  <div class="panel-body">

            		<ul>
					<li class="col-sm-4">
						<ul>
							<li class="dropdown-header">Houses</li>
							<li><a href="view_product.php">Apartment for rent</a></li>
							<li><a href="#">Apartment for sale</a></li>
						</ul>
					</li>
					<li class="col-sm-4">
						<ul>
							<li class="dropdown-header">Commercials</li>
							<li><a href="#">Commmercial for rent</a></li>
					...
					<li class="col-sm-4">
						<ul>
							...
							<li><a href="#">Shared rooms for rent</a></li>
